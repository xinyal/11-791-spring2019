...
def get_mfcc(FILENAME, DESTPATH):
	...
	outfile = DESTPATH + '/' + os.path.splitext(os.path.basename(FILENAME))[0] + '.npy'
	np.save(outfile, np.array(mfccs))
