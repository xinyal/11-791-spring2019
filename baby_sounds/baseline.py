...
# Process labels
labels_file = '/home1/srallaba/challenges/compare2019/ComParE2019_BabySounds/lab/labels.csv'
labels = {}
ids = ['Canonical','Crying','Junk', 'Laughing', 'Non-canonical', '?']
f = open(labels_file)
cnt = 0 
for line in f:
  if cnt == 0:
...
def train():
 ...
 for ctr, t in enumerate(train_loader):
    a,b = t
    #print("Shape of input, output: ", a.shape, b.shape, b)
